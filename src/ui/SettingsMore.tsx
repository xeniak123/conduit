  ...
  return (
    <section className="sect">
      ...
      <div className="card">
        <Setting
          label="Version"
          help={`0.3.4 · ${updates.checking ? "checking…" : updates.available ? `${updates.available.version} is available` : updates.error ? "could not check for updates" : updates.checkedAt ? "up to date" : "updates are checked automatically"}`}
        >
